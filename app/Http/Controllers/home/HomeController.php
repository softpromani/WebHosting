...
class HomeController extends Controller
{
    ...
    public function enterpriseWirelessSolutions()
    {
        return view('home.services.network_solution.enterprise_wireless_solutions');
    }

    public function vpnRemoteAccess()
    {
        return view('home.services.network_solution.vpn_remote_access');
    }

    public function networkMonitoring()
    {
        return view('home.services.network_solution.network_monitoring');
    }

    public function firewallRouterConfiguration()
    {
        return view('home.services.network_solution.firewall_router_configuration');
    }

    public function disasterRecoveryRedundancy()
    {
