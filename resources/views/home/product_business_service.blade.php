            ...
            <ul class="nav nav-tabs flex-column justify-content-center border-0 text-left fw-500 fs-18 alt-font">
                <li class="nav-item">
                    <a data-bs-toggle="tab" href="#tab_four1" class="nav-link d-flex align-items-center active">
                        <i class="fas fa-briefcase icon-extra-medium text-dark-gray"></i><span>Business planning</span>
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="tab" href="#tab_four3">
                        <i class="fas fa-compass icon-extra-medium text-dark-gray"></i><span>Tracking operations</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="tab" href="#tab_four4">
                        <i class="fas fa-bullhorn icon-extra-medium text-dark-gray"></i><span>Business campaign</span>
                    </a>
                </li>
            </ul>
        </div>
        ...
        <div class="col-xl-9 col-lg-8 col-md-12">
            <div class="tab-content">
                ...
                <div class="tab-pane fade show active" id="tab_four1">
                    <div class="row ">
                        <div class="col-md-6 offset-xl-1 sm-mb-30px">
                            <img src="{{ asset('home/assets/img/demo-business-tab-01.jpg') }}" alt="Business Planning"
                        ...
                        <div class="col-xl-4 col-md-6 offset-xl-1  text-md-start">
                            ...
                            <h2 class="alt-font text-dark-gray mb-20px fw-500 ls-minus-1px"><span class="fw-600">Work
                ...
                <div class="tab-pane fade" id="tab_four2">
                    <div class="row ">
                        <div class="col-md-6 offset-xl-1 sm-mb-30px">
                            <img src="{{ asset('home/assets/img/demo-business-tab-02.jpg') }}" alt="Business Planning"
                                class="border-radius-6px w-100" />
                        </div>
                        <div class="col-xl-4 col-md-6 offset-xl-1  text-md-start">
                            ...
                            <h2 class="alt-font text-dark-gray mb-20px fw-500 ls-minus-1px"><span class="fw-600">Help
                                    our clients </span>succeed by brand</h2>
                            <p class="justify" style="font-weight: 400rem; font-size:20px; color:darkgray">We always
                                want our client grow with the product we have delivered and maintaining strong long-term
                                good relationship.</p>
                ...
                <div class="tab-pane fade" id="tab_four3">
                    <div class="row ">
                        <div class="col-md-6 offset-xl-1 sm-mb-30px">
                            <img src="{{ asset('home/assets/img/demo-business-tab-03.jpg') }}" alt="Business Planning"
                                class="border-radius-6px w-100" />
                        </div>
                        <div class="col-xl-4 col-md-6 offset-xl-1  text-md-start">
                ...
                <div class="tab-pane fade" id="tab_four4">
                    <div class="row ">
                        <div class="col-md-6 offset-xl-1 sm-mb-30px">
                            <img src="{{ asset('home/assets/img/demo-business-tab-04.jpg') }}" alt="Business Planning"
                                class="border-radius-6px w-100" />
                        </div>
                        <div class="col-xl-4 col-md-6 offset-xl-1  text-md-start">
