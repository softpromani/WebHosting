    ...
    <div class="container-fluid py-5">
        <div class="row align-items-center">
            ...
            <div class="col-md-5 mb-4 mb-md-0">
                <img src="{{ asset('home/assets/img/Tax-Streamline Your Workflow.webp')}}"
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-6 " data-aos="fade-up" data-aos-delay="200">
                    <div class="card-img" style="margin-left: 70px">
                        <img src="{{ asset('storage/' . optional($products->content_img)->media) }}" alt="Tax Software Hosting Service Image - Mounteko"
        ...
        <div class="container">
            <div class="row gy-4">
                ...
                <div class="col-lg-6 text-end" data-aos="fade-up" data-aos-delay="200">
                    <div class="card-img">
                        <img src="{{ asset('home/assets/img/Tax-  Why choose.webp')}}" alt="Tax Software Cloud Hosting - Why Choose Mounteko"
            ...
            <div class="row justify-content-center">
                <div class="col-xl-4 ">
                    <div class="card-img mb-3">
                        <img src="{{ asset('home/assets/img/Faqs-Common.webp') }}" alt="Tax Software Cloud Hosting FAQs - Mounteko"
